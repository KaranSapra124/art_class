        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown" ref={collapseRef}>
          <ul className="navbar-nav me-auto">
            <li className="nav-item">
              <Link className="nav-link active" to="/art_class/">HOME</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link active" to="/art_class/about">ABOUT US</Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link active" to="/art_class/classes">CLASSES</Link>
            </li>
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li><Link className="dropdown-item" to="/art_class/workshop">Our Art Workshop</Link></li>
                <li><Link className="dropdown-item" to="/art_class/tutorial">Workshop Tutorial</Link></li>
              </ul>
            </li>
            <li className="nav-item">
              <Link className="nav-link active" to="/art_class/contact">CONTACT</Link>
            </li>
          </ul>

          <ul className="navbar-nav ms-auto">
            <li className="nav-item">
              <Link to="/art_class/login">
